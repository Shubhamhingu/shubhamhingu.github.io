        ...
        init: function() {
            e(".vlt-animated-block").each(function() {
                ...
                VLTJS.window.on("vlt.change-slide", function() {
                    ...
                    t.parents(".vlt-section").hasClass("active") && t.addClass("animated")
                })
            })
        }
    },
            ...
            if (void 0 !== e.fn.pagepiling) {
                ...
                s.pagepiling({
                    ...
                    afterLoad: function(e, n) {
                        r.find("li.active").prevAll().addClass("prev"),
                        t()
                    }
                }),
        ...
        init: function() {
            if ("undefined" != typeof gsap) {
                e(".vlt-progress-bar").each(function() {
                    ...
                    VLTJS.window.on("vlt.change-slide", function() {
                        t.parents(".vlt-section").hasClass("active") && (o.count = 0,
...
function(e) {
    ...
    VLTJS.projectShowcase = {
        ...
        initParallax: function() {
            if ("undefined" != typeof gsap) {
                var t, n, i = e(".vlt-project-showcase"), a = i.find(".vlt-project-showcase__items"), o = a.find(".vlt-project-showcase__item"), s = i.find(".vlt-project-showcase__images"), r = s.find(".vlt-project-showcase__image"), l = i.outerWidth(!0), c = s.outerWidth(!0), u = a.outerWidth(), d = (l - c) / l;
                t = u / l - 1,
                t = (l - u) / l,
