...
function(t, e) {
    ...
    function S() {
        var t, e, i = je.length, n = je.slice(0);
        for (qe = {},
        t = je.length = 0; t < i; t++)
    ...
    function V(t, e, i, n) {
        return xi(t, e),
        t._initted ? !i && t._pt && (t._dur && !1 !== t.vars.lazy || !t._dur && t.vars.lazy) && re !== li.frame ? (je.push(t),
        t._lazy = [e, n],
        1) : void 0 : 1
    }
    function N(t, e, i) {
    ...
    function j(t, e) {
        ...
        1 < i ? j(t, e.substr(0, i - 1)) + s : o + s) : null == e ? o : +e
    }
    function q(t, e) {
        return t || 0 === t ? e(t) : e
    }
    ...
    function W(t) {
        ...
        p = a[1]),
        function(t, n, s) {
            var o, c, f, m, v, g, b, y, x, T = (s || e).length, S = l[T];
            if (!S) {
                ...
                for (S = l[T] = [],
                o = d ? Math.min(x, T) * u - .5 : a % x,
                c = d ? T * p / x - .5 : a / x | 0,
                y = Ee,
                g = b = 0; g < T; g++)
                    f = g % x - o,
                    m = c - (g / x | 0),
                    S[g] = v = h ? Math.abs("y" === h ? m : f) : $e(f * f + m * m),
                    b < v && (b = v),
                    v < y && (y = v);
                "random" === a && G(S),
                S.max = b - y,
    ...
    function J(t, e) {
        ...
        : function(e) {
            for (var s, r, o = parseFloat(n ? e.x : e), l = parseFloat(n ? e.y : 0), c = Ee, d = 0, h = t.length; h--; )
                (s = n ? (s = t[h].x - o) * s + (r = t[h].y - l) * r : Math.abs(t[h] - o)) < c && (c = s,
                d = h);
    ...
    function nt(t, e, i) {
        ...
        d === h ? o = l = 0 : (u = d - h,
        l = .5 < c ? u / (2 - d - h) : u / (d + h),
        o = d === n ? (s - r) / u + (s < r ? 6 : 0) : d === s ? (r - n) / u + 2 : (n - s) / u + 4,
        o *= 60),
        f[0] = ~~(o + .5),
        f[1] = ~~(100 * l + .5),
        f[2] = ~~(100 * c + .5)),
    ...
    function Dt(t) {
        var e, i = At("svg", this.ownerSVGElement && this.ownerSVGElement.getAttribute("xmlns") || "http://www.w3.org/2000/svg"), n = this.parentNode, s = this.nextSibling, a = this.style.cssText;
        if (Hi.appendChild(i),
        i.appendChild(this),
    ...
    function Ht(t, e, i, n) {
        var s, a, r, o, l = parseFloat(i) || 0, c = (i + "").trim().substr((l + "").length) || "px", d = qi.style, h = bn.test(e), u = "svg" === t.tagName.toLowerCase(), p = (u ? "client" : "offset") + (h ? "Width" : "Height"), f = "px" === n;
        return n === c || !l || En[n] || En[c] ? l : (o = t.getCTM && Rt(t),
        "%" === n && (pn[e] || ~e.indexOf("adius")) ? w(l / (o ? t.getBBox()[h ? "width" : "height"] : t[p]) * 100) : (d[h ? "width" : "height"] = 100 + (f ? c : n),
        a = ~e.indexOf("adius") || "em" === n && t.appendChild && !u ? t : t.parentNode,
        o && (a = (t.ownerSVGElement || {}).parentNode),
        a && a !== Ni && a.appendChild || (a = Ni.body),
        (r = a._gsap) && "%" === n && r.width && h && r.time === li.time ? w(l / r.width * 100) : (a === t && (d.position = "static"),
        a.appendChild(qi),
        s = qi[p],
        a.removeChild(qi),
        d.position = "absolute",
        h && "%" === n && ((r = g(a)).time = li.time,
        r.width = a[p]),
        w(f ? s * l / 100 : 100 / s * l))))
    }
    function jt(t, e, i, n) {
        ...
        s = "transformOrigin" !== e ? s[e] : Ln(Ot(t, Tn)) + " " + s.zOrigin + "px") : (s = t.style[e]) && "auto" !== s && !n && !~(s + "").indexOf("calc(") || (s = Mn[e] && Mn[e](t, e, i) || Ot(t, e) || b(t, e) || ("opacity" === e ? 1 : 0)),
    ...
    function qt(t, e, i, n) {
        ...
        var r, o, l, c, d, h, u, p, f, m, v, g, b = new Fi(this._pt,t.style,e,0,1,zi), y = 0, w = 0;
        if (b.b = i,
        b.e = n,
        i += "",
        "auto" == (n += "") && (t.style[e] = n,
    ...
    function Ut(t, e) {
        var i, n, s, a, r = t._gsap || g(t), o = t.style, l = Wt(t);
        return r.svg && t.getAttribute("transform") ? "1,0,0,1,0,0" === (l = [(s = t.transform.baseVal.consolidate().matrix).a, s.b, s.c, s.d, s.e, s.f]).join(",") ? kn : l : (l !== kn || t.offsetParent || t === Hi || r.svg || (s = o.display,
        o.display = "block",
    ...
    function Jt(t, e, i, n, s, a) {
        var r, o, l, c = t._gsap, d = s || Ut(t, !0), h = c.xOrigin || 0, u = c.yOrigin || 0, p = c.xOffset || 0, f = c.yOffset || 0, m = d[0], v = d[1], g = d[2], b = d[3], y = d[4], w = d[5], x = e.split(" "), T = parseFloat(x[0]) || 0, S = parseFloat(x[1]) || 0;
        i ? d !== kn && (o = m * b - v * g) && (l = T * (-v / o) + S * (m / o) - (m * w - v * y) / o,
        T = T * (b / o) + S * (-g / o) + (g * w - b * y) / o,
        S = l) : (T = (r = Bt(t)).x + (~x[0].indexOf("%") ? T / 100 * r.width : T),
        S = r.y + (~(x[1] || x[0]).indexOf("%") ? S / 100 * r.height : S)),
        n || !1 !== n && c.smooth ? (y = T - h,
        w = S - u,
    ...
    function Kt(t, e, i, s, a, r) {
        var o, l, c = 360, d = n(a), h = parseFloat(a) * (d && ~a.indexOf("rad") ? fn : 1), u = r ? h * r : h - s, p = s + u + "deg";
        return d && ("short" === (o = a.split("_")[1]) && (u %= c) != u % 180 && (u += u < 0 ? c : -c),
        "cw" === o && u < 0 ? u = (u + 36e9) % c - ~~(u / c) * c : "ccw" === o && 0 < u && (u = (u - 36e9) % c - ~~(u / c) * c)),
    ...
    function Zt(t, e, i) {
        var n, s, a, r, o, l, c, d = Yi.style, h = i._gsap;
        for (s in d.cssText = getComputedStyle(i).cssText + ";position:absolute;display:block;",
        d[xn] = e,
        Ni.body.appendChild(Yi),
        n = $n(Yi, 1),
        pn)
            (a = h[s]) !== (r = n[s]) && "perspective,force3D,transformOrigin,svgOrigin".indexOf(s) < 0 && (o = Y(a) !== (c = Y(r)) ? Ht(i, s, a, c) : parseFloat(a),
            l = parseFloat(r),
    ...
    var te, ee, ie, ne, se, ae, re, oe, le, ce, de, he, ue, pe, fe, me, ve, ge, be, ye, we, xe, Te, Se = {
        ...
        overwrite: !1,
        delay: 0
    }, Ee = 1e8, _e = 1 / Ee, Me = 2 * Math.PI, ke = Me / 4, Pe = 0, $e = Math.sqrt, Le = Math.cos, ze = Math.sin, Ae = Array.isArray, Oe = /(?:-?\.?\d|\.)+/gi, Ie = /[-+=.]*\d+[.e\-+]*\d*[e\-\+]*\d*/g, De = /[-+=.]*\d+[.e-]*\d*[a-z%]*/g, Fe = /[-+=.]*\d+(?:\.|e-|e)*\d*/gi, Be = /\(([^()]+)\)/i, Re = /[+-]=-?[\.\d]+/, Ve = /[#\-+.]*\b[a-z\d-=+%.]+/gi, Ne = {}, He = {}, je = [], qe = {}, Ye = {}, Xe = {}, Ge = 30, We = [], Ue = "", Je = function(t, e) {
        for (var i in e)
            t[i] = e[i];
        return t
    }, Qe = function(t, e) {
    ...
    ue = {
        ...
        return !le && li.wake()
    }, di = {}, hi = /^[\d.\-M][\d.\-,\s]/, ui = /["']/g, pi = function(t) {
        return function(e) {
            return 1 - t(1 - e)
        }
    }, fi = function(t, e) {
    ...
    mi.totalDuration = function(t) {
        ...
        N(this, this._repeat < 0 ? t : (t - this._repeat * this._rDelay) / (this._repeat + 1))) : this._tDur
    }
    ,
    ...
    var bi = function(t) {
        ...
        return o.to = function(t, e, i, n) {
            return new Ei(t,T(arguments, 0, this),j(this, a(e) ? n : i)),
            this
        }
        ,
        o.from = function(t, e, i, n) {
            return new Ei(t,T(arguments, 1, this),j(this, a(e) ? n : i)),
            this
        }
        ,
        o.fromTo = function(t, e, i, n, s) {
            return new Ei(t,T(arguments, 2, this),j(this, a(e) ? s : n)),
            this
        }
        ,
        ...
        o.render = function(t, e, i) {
            var n, s, a, r, o, l, c, d, h, u, p, f, m = this._time, v = this._dirty ? this.totalDuration() : this._tDur, g = this._dur, b = this !== te && v - _e < t && 0 <= t ? v : t < _e ? 0 : t, y = this._zTime < 0 != t < 0 && (this._initted || !g);
            if (b !== this._tTime || i || y) {
                ...
                m <= n && 0 <= t)
                    ...
                    for (var S = t < 0 ? t : n; s; ) {
                        ...
                        (s._act || S <= s._end) && s._ts && c !== s) {
                            if (s.parent !== this)
                                return this.render(t, e, i);
                            if (s.render(0 < s._ts ? (S - s._start) * s._ts : (s._dirty ? s.totalDuration() : s._tDur) + (S - s._start) * s._ts, e, i),
                            n !== this._time || !this._ts && !l) {
                                c = 0,
                                a && (b += this._zTime = S ? -_e : _e);
                                break
                            }
                        }
                        s = a
                ...
                (b === v && v >= this.totalDuration() || !b && this._ts < 0) && (h !== this._start && Math.abs(d) === Math.abs(this._ts) || (!t && g || !(t && 0 < this._ts || !b && this._ts < 0) || A(this, 1),
        ...
        ,
        o.remove = function(t) {
            return n(t) ? this.removeLabel(t) : s(t) ? this.killTweensOf(t) : (z(this, t),
    ...
    var yi, wi = function(t, e, i, a, r, o, l, c, d) {
        s(a) && (a = a(r || 0, t, o));
        var h, p = t[e], f = "get" !== i ? i : s(p) ? d ? t[e.indexOf("set") || !s(t["get" + e.substr(3)]) ? e : "get" + e.substr(3)](d) : t[e]() : p, m = s(p) ? d ? ki : Mi : _i;
        if (n(a) && (~a.indexOf("random(") && (a = Z(a)),
        "=" === a.charAt(1) && (a = parseFloat(f) + parseFloat(a.substr(2)) * ("-" === a.charAt(0) ? -1 : 1) + (Y(f) || 0))),
        f !== a)
            return isNaN(f + a) ? (p || e in t || u(e, a),
            function(t, e, i, n, s, a, r) {
                var o, l, c, d, h, u, p, f, m = new Fi(this._pt,t,e,0,1,zi,null,s), v = 0, g = 0;
                for (m.b = i,
                m.e = n,
                i += "",
        ...
        !V) {
            ...
            s = 0; s < D.length; s++) {
                ...
                qe[d.id] && S(),
                f = B === D ? s : B.indexOf(o),
                h && !1 !== (u = new h).init(o, m || n, e, f, B) && (e._pt = r = new Fi(e._pt,o,u.name,0,1,u.render,u,0,u.priority),
                ...
                !h || m)
                    for (a in n)
                        Ye[a] && (u = mt(a, n, e, f, o, B)) ? u.priority && (c = 1) : p[a] = r = wi.call(e, o, a, "get", n[a], f, B, 0, b.stringFilter);
        ...
        e._from = !V && !!b.runBackwards,
        e._onUpdate = C,
        e._initted = 1
    }, Ti = function(t, e, i, a, r) {
        return s(t) ? t.call(e, i, a, r) : n(t) && ~t.indexOf("random(") ? Z(t) : t
    }, Si = Ue + "repeat,repeatDelay,yoyo,repeatRefresh,yoyoEase", Ci = (Si + ",id,stagger,delay,duration,paused").split(","), Ei = function(t) {
        function s(e, n, s, r) {
            var c;
            "number" == typeof n && (s.duration = n,
            n = s,
            s = null);
            var h, u, f, g, b, y, w, x, T = (c = t.call(this, r ? n : L(n), s) || this).vars, S = T.duration, C = T.delay, E = T.immediateRender, _ = T.stagger, k = T.overwrite, P = T.keyframes, $ = T.defaults, z = c.parent, A = (Ae(e) ? a(e[0]) : "length"in n) ? [e] : ei(e);
            if (c._targets = A.length ? v(A) : p("GSAP target " + e + " not found. https://greensock.com", !Se.nullTargetWarn) || [],
            c._ptLookup = [],
            c._overwrite = k,
            P || _ || d(S) || d(C)) {
                if (n = c.vars,
            ...
            yi = 0),
            z && B(z, i(c)),
            (E || !S && !P && c._start === z._time && l(E) && function t(e) {
                return !e || e._ts && t(e.parent)
            }(i(c)) && "nested" !== z.data) && (c._tTime = -_e,
        ...
        return r.render = function(t, e, i) {
            var n, s, a, r, o, l, c, d, h, u = this._time, p = this._tDur, f = this._dur, m = p - _e < t && 0 <= t ? p : t < _e ? 0 : t;
            if (f) {
                if (m !== this._tTime || !t || i || this._startAt && this._zTime < 0 != t < 0) {
                    ...
                    e || t < 0 && !u || m < p && 0 < this.timeScale() || (ni(this, m === p ? "onComplete" : "onReverseComplete", !0),
                    this._prom && this._prom()))
                }
            } else
                !function(t, e, i, n) {
                    ...
                    (t._initted || !V(t, e, n, i)) && (r !== a || n || t._zTime === _e || !e && t._zTime)) {
                        ...
                        (e >= t._tDur || e < 0) && t.ratio === r && (t.ratio && A(t, 1),
        ...
        r.kill = function(t, e) {
            ...
            if (this.timeline)
                ...
                this;
            var i, s, a, r, o, l, c, d = this._targets, h = t ? ei(t) : d, u = this._ptLookup, p = this._pt;
            ...
            c = d.length); c--; )
                if (~h.indexOf(d[c]))
                    ...
                    r = e),
                    r)
                        (l = s && s[o]) && ("kill"in l.d && !0 !== l.d.kill(o) || z(this, l, "_pt"),
                        delete s[o]),
                        "all" !== a && (a[o] = 1);
    ...
    var _i = function(t, e, i) {
      ...
      , Ii = function(t) {
        for (var e, i, n = this._pt; n; )
            i = n._next,
            n.p === t && !n.op || n.op === t ? z(this, n, "_pt") : n.dep || (e = 1),
            n = i;
        return !e
    }
      , Di = function(t) {
    ...
    ae = 1,
    c() && ci();
    var Vi, Ni, Hi, ji, qi, Yi, Xi, Gi, Wi = di.Power0, Ui = di.Power1, Ji = di.Power2, Qi = di.Power3, Ki = di.Power4, Zi = di.Linear, tn = di.Quad, en = di.Cubic, nn = di.Quart, sn = di.Quint, an = di.Strong, rn = di.Elastic, on = di.Back, ln = di.SteppedEase, cn = di.Bounce, dn = di.Sine, hn = di.Expo, un = di.Circ, pn = {}, fn = 180 / Math.PI, mn = Math.PI / 180, vn = Math.atan2, gn = /([A-Z])/g, bn = /(?:left|right|width|margin|padding|x)/i, yn = /[\s,\(]\S/, wn = {
        autoAlpha: "opacity,visibility",
        scale: "scaleX,scaleY",
        alpha: "opacity"
    }, xn = "transform", Tn = xn + "Origin", Sn = "O,Moz,ms,Ms,Webkit".split(","), Cn = function(t, e, i) {
        var n = (e || qi).style
          , s = 5;
        if (t in n && !i)
            return t;
        ...
        if ("x"in i && !e && !i.uncache)
            return i;
        var n, s, a, r, o, l, c, d, h, u, p, f, m, v, g, b, y, x, T, S, C, E, _, M, k, P, $, L, z, A, O, I, D = t.style, F = i.scaleX < 0, B = "deg", R = Ot(t, Tn) || "0";
        return n = s = a = l = c = d = h = u = p = 0,
        r = o = 1,
        i.svg = !(!t.getCTM || !Rt(t)),
        v = Ut(t, i.svg),
        ...
        n = E = v[4],
        s = _ = v[5],
        6 === v.length ? (r = Math.sqrt(x * x + T * T),
        o = Math.sqrt(C * C + S * S),
        l = x || T ? vn(T, x) * fn : 0,
        ...
        S = P = S * b - z * y),
        l = (g = vn(T, x)) * fn,
        g && (M = x * (b = Math.cos(g)) + T * (y = Math.sin(g)),
        k = E * b + _ * y,
        T = T * b - x * y,
        _ = _ * b - E * y,
        x = M,
        ...
        90 < Math.abs(h) && Math.abs(h) < 270 && (F ? (r *= -1,
        h += l <= 0 ? 180 : -180,
        l += l <= 0 ? 180 : -180) : (o *= -1,
        h += h <= 0 ? 180 : -180)),
        ...
        e.force3D = 0,
        Dn(t, e)
    }, An = "0deg", On = "0px", In = ") ", Dn = function(t, e) {
        var i = e || this
          , n = i.xPercent
          , s = i.yPercent
          , a = i.x
          ...
          , w = "auto" === v && t && 1 !== t || !0 === v;
        if (b && (d !== An || c !== An)) {
            var x, T = parseFloat(c) * mn, S = Math.sin(T), C = Math.cos(T);
            T = parseFloat(d) * mn,
            x = Math.cos(T),
            a = Qt(g, a, S * x * -b),
        ...
        var i, n, s, a, r, o = e || this, l = o.xPercent, c = o.yPercent, d = o.x, h = o.y, u = o.rotation, p = o.skewX, f = o.skewY, m = o.scaleX, v = o.scaleY, g = o.target, b = o.xOrigin, y = o.yOrigin, x = o.xOffset, T = o.yOffset, S = o.forceCSS, C = parseFloat(d), E = parseFloat(h);
        u = parseFloat(u),
        p = parseFloat(p),
        ...
        a = v,
        n = s = 0),
        (C && !~(d + "").indexOf("px") || E && !~(h + "").indexOf("px")) && (C = Ht(g, "x", d, "px"),
        E = Ht(g, "y", h, "px")),
        (b || y || x || T) && (C = w(C + b - (b * i + y * s) + x),
        E = w(E + y - (b * n + y * a) + T)),
        (l || c) && (r = g.getBBox(),
        C = w(C + l / 100 * r.width),
    ...
    var Bn, Rn, Vn, Nn = {
        ...
        init: function(t, e, i, n, s) {
            var a, r, o, l, c, d, h, p, f, m, v, g, b, y, w, x = this._props, T = t.style;
            for (h in ji || It(),
            e)
                if ("autoRound" !== h && (r = e[h],
                !Ye[h] || !mt(h, e, i, n, t, s)))
                    if (c = typeof r,
                    d = Mn[h],
                    ...
                    d)
                        ...
                        this.add(T, "setProperty", getComputedStyle(t).getPropertyValue(h) + "", r + "", n, s, 0, 0, h);
                    else {
                        if (a = jt(t, h),
                        l = parseFloat(a),
                        (m = "string" === c && "=" === r.charAt(1) ? +(r.charAt(0) + "1") : 0) && (r = r.substr(2)),
                        o = parseFloat(r),
                        h in wn && ("autoAlpha" === h && (1 === l && "hidden" === jt(t, "visibility") && o && (l = 0),
                        Nt(this, T, "visibility", l ? "inherit" : "hidden", o ? "inherit" : "hidden", !o)),
                        "scale" !== h && "transform" !== h && ~(h = wn[h]).indexOf(",") && (h = h.split(",")[0])),
                        v = h in pn)
                            if (g || ((b = t._gsap).renderTransform || $n(t),
                            y = !1 !== e.smoothOrigin && b.smooth,
                            (g = this._pt = new Fi(this._pt,T,xn,0,1,b.renderTransform,b,0,-1)).dep = 1),
                            "scale" === h)
                                ...
                                if ("transformOrigin" === h) {
                                    r = Yt(r),
                                    b.svg ? Jt(t, r, 0, y, 0, this) : ((f = parseFloat(r.split(" ")[2]) || 0) !== b.zOrigin && Nt(this, b, "zOrigin", b.zOrigin, f),
    ...
    t.fn.pagepiling = function(s) {
        ...
        function o(e, i) {
            ...
            if (!n.activeSection.is(e)) {
                ...
                n.scrolling = "-100%",
                Q.css3 || n.sectionsToMove.each(function(e) {
        ...
        function l(e) {
            Q.css3 ? (y(e.animateSection, e.translate3d, e.animated),
            e.sectionsToMove.each(function() {
                y(t(this), e.translate3d, e.animated)
            }),
            setTimeout(function() {
                c(e)
            }, Q.scrollingSpeed)) : (e.scrollOptions = u(e.scrolling),
            e.animated ? e.animateSection.animate(e.scrollOptions, Q.scrollingSpeed, Q.easing, function() {
                h(e),
                c(e)
        ...
        function p(t, e) {
            Q.anchors.length ? (location.hash = t,
        ...
        function w(e) {
            ...
            !v()) {
                var c = t(".pp-section.active")
                  , d = C(c);
                return x(U, 10) >= x(U, 70) && o && (a < 0 ? T("down", d) : a > 0 && T("up", d)),
                !1
            }
        }
        function x(t, e) {
        ...
        function E() {
            H.get(0).addEventListener ? (H.get(0).removeEventListener("mousewheel", w, !1),
            H.get(0).removeEventListener("wheel", w, !1)) : H.get(0).detachEvent("onmousewheel", w)
        }
        function _() {
            H.get(0).addEventListener ? (H.get(0).addEventListener("mousewheel", w, !1),
            H.get(0).addEventListener("wheel", w, !1)) : H.get(0).attachEvent("onmousewheel", w)
        }
        function M() {
            if (q) {
                var t = P();
        ...
        function k() {
            if (q) {
                var t = P();
                H.off("touchstart " + t.down),
                H.off("touchmove " + t.move)
            }
        }
        function P() {
        ...
        function A(e) {
            ...
            if (!O(e.target) && L(i)) {
                ...
                !v()) {
                    ...
                    G = a.y,
                    W = a.x,
                    "horizontal" === Q.direction && Math.abs(X - W) > Math.abs(Y - G) ? Math.abs(X - W) > H.width() / 100 * Q.touchSensitivity && (X > W ? T("down", s) : W > X && T("up", s)) : Math.abs(Y - G) > H.height() / 100 * Q.touchSensitivity && (Y > G ? T("down", s) : G > Y && T("up", s))
                }
            }
        }
        function O(e, i) {
        ...
        function I() {
            ...
            for (var i = 0; i < t(".pp-section").length; i++) {
                var n = "";
                if (Q.anchors.length && (n = Q.anchors[i]),
        ...
        function D(e, i) {
            Q.navigation && (t("#pp-nav").find(".active").removeClass("active"),
            e ? t("#pp-nav").find('a[href="#' + e + '"]').addClass("active") : t("#pp-nav").find("li").eq(i).find("a").addClass("active"))
        }
        function F(e) {
            Q.menu && (t(Q.menu).find(".active").removeClass("active"),
            t(Q.menu).find('[data-menuanchor="' + e + '"]').addClass("active"))
        }
        function B() {
        ...
        var V, N = t.fn.pagepiling, H = t(this), j = 0, q = "ontouchstart"in i || navigator.msMaxTouchPoints > 0 || navigator.maxTouchPoints, Y = 0, X = 0, G = 0, W = 0, U = [], J = 600, Q = t.extend(!0, {
            direction: "vertical",
            menu: null,
            verticalCentered: !0,
            sectionsColor: [],
        ...
        N.setAllowScrolling = function(t) {
            t ? (N.setMouseWheelScrolling(!0),
            M()) : (N.setMouseWheelScrolling(!1),
            k())
        }
        ,
        ...
        t(".pp-section").each(function(e) {
            ...
            Q.navigation && (t("#pp-nav").css("margin-top", "-" + t("#pp-nav").height() / 2 + "px"),
...
function(t, e) {
        ...
        if (t)
            if ("string" == typeof t) {
                ...
                if (r.indexOf("<") >= 0 && r.indexOf(">") >= 0) {
                    ...
                    for (s = e || "#" !== t[0] || t.match(/[ .<>:~]/) ? (e || h).querySelectorAll(t.trim()) : [h.getElementById(t.trim().split("#")[1])],
                    n = 0; n < s.length; n += 1)
                        s[n] && i.push(s[n])
            } else if (t.nodeType || t === p || t === h)
                i.push(t);
                ...
                if (n.noSwiping && r.closest(n.noSwipingSelector ? n.noSwipingSelector : "." + n.noSwipingClass)[0])
                    ...
                    if (!c || !(o <= d || o >= p.screen.width - d)) {
                        ...
                        "touchstart" !== a.type) {
                            ...
                            h.activeElement && i(h.activeElement).is(e.formElements) && h.activeElement !== r[0] && h.activeElement.blur();
            ...
            if (!e.isTouchEvent || "touchmove" === r.type) {
                ...
                if (e.isTouchEvent && n.touchReleaseOnEdges && !n.loop)
                    if (this.isVertical()) {
                        ...
                        return;
                if (e.isTouchEvent && h.activeElement && r.target === h.activeElement && i(r.target).is(e.formElements))
                    return e.isMoved = !0,
                ...
                !(r.targetTouches && r.targetTouches.length > 1)) {
                    ...
                    if (!(this.params.threshold && Math.sqrt(Math.pow(d, 2) + Math.pow(u, 2)) < this.params.threshold)) {
                        var p;
                        if (void 0 === e.isScrolling && (this.isHorizontal() && s.currentY === s.startY || this.isVertical() && s.currentX === s.startX ? e.isScrolling = !1 : d * d + u * u >= 25 && (p = 180 * Math.atan2(Math.abs(u), Math.abs(d)) / Math.PI,
    ...
    function r(t) {
        ...
        var d, h = v.now(), u = h - i.touchStartTime;
        if (e.allowClick && (e.updateClickedSlide(c),
        e.emit("tap click", c),
        u < 300 && h - i.lastClickTime < 300 && e.emit("doubleTap doubleClick", c)),
            ...
            if (n.freeMode) {
                ...
                if (n.freeModeMomentum) {
                    ...
                    var b = 1e3 * n.freeModeMomentumRatio
                      ...
                      , w = e.translate + y;
                    a && (w = -w);
                    var x, T, S = !1, C = 20 * Math.abs(e.velocity) * n.freeModeMomentumBounceRatio;
                    if (w < e.maxTranslate())
                    ...
                    n.freeModeMomentumBounce && S ? (e.updateProgress(x),
                    e.setTransition(b),
                    e.setTranslate(w),
                ...
                for (var P = 0, $ = e.slidesSizesGrid[0], L = 0; L < o.length; L += L < n.slidesPerGroupSkip ? 1 : n.slidesPerGroup) {
                    ...
                    void 0 !== o[L + z] ? d >= o[L] && d < o[L + z] && (P = L,
                    $ = o[L + z] - o[L]) : d >= o[L] && (P = L,
                ...
                if (u > n.longSwipesMs) {
                    if (!n.longSwipes)
                        return void e.slideTo(e.activeIndex);
                    "next" === e.swipeDirection && (A >= n.longSwipesRatio ? e.slideTo(P + O) : e.slideTo(P)),
                    "prev" === e.swipeDirection && (A > 1 - n.longSwipesRatio ? e.slideTo(P + O) : e.slideTo(P))
                } else {
                    if (!n.shortSwipes)
                        return void e.slideTo(e.activeIndex);
        ...
        off: function() {
            ...
            for (var o = n.split(" "), l = 0; l < o.length; l += 1)
                for (var c = o[l], d = 0; d < this.length; d += 1) {
                    var h = this[d]
                      , u = void 0;
                    if (!s && h.dom7Listeners ? u = h.dom7Listeners[c] : s && h.dom7LiveListeners && (u = h.dom7LiveListeners[c]),
                    u && u.length)
                        for (var p = u.length - 1; p >= 0; p -= 1) {
                            var f = u[p];
                            a && f.listener === a || a && f.listener && f.listener.dom7proxy && f.listener.dom7proxy === a ? (h.removeEventListener(c, f.proxyListener, r),
                            u.splice(p, 1)) : a || (h.removeEventListener(c, f.proxyListener, r),
                            u.splice(p, 1))
                        }
                }
            return this
    ...
    var w, x, T, S, C, E, _, M, k, P, $, L, z, A, O, I = {
                ...
                for (var E, _ = e.slidesPerColumn, M = S / _, k = Math.floor(c / e.slidesPerColumn), P = 0; P < c; P += 1) {
                    ...
                    if (e.slidesPerColumn > 1) {
                        ...
                        if ("row" === e.slidesPerColumnFill && e.slidesPerGroup > 1) {
                            ...
                            L = (z = I - (A = Math.floor(I / D)) * D + O * e.slidesPerGroup) + A * S / _,
                            $.css({
                            ...
                            "column" === e.slidesPerColumnFill ? (A = P - (z = Math.floor(P / _)) * _,
                            (z > k || z === k && A === _ - 1) && (A += 1) >= _ && (A = 0,
                            z += 1)) : z = P - (A = Math.floor(P / M)) * M;
                    ...
                    if ("none" !== $.css("display")) {
                        ...
                        (T - Math.min(this.params.slidesPerGroupSkip, T)) % this.params.slidesPerGroup == 0 && d.push(w),
                        h.push(w),
                        w = w + C + y),
        ...
        translateTo: function(t, e, i, n, s) {
            ...
            if (r.animating && o.preventInteractionOnTransition)
                return !1;
            var c, d = r.minTranslate(), h = r.maxTranslate();
            if (c = n && t > d ? d : n && t < h ? h : t,
            r.updateProgress(c),
            o.cssMode) {
                var u = r.isHorizontal();
                return 0 === e ? l[u ? "scrollLeft" : "scrollTop"] = -c : l.scrollTo ? l.scrollTo(((a = {})[u ? "left" : "top"] = -c,
                a.behavior = "smooth",
                a)) : l[u ? "scrollLeft" : "scrollTop"] = -c,
                !0
            }
        ...
        slideTo: function(t, e, i, n) {
            ...
            if (o.cssMode) {
                var y = a.isHorizontal()
                  , w = -g;
                return u && (w = p.scrollWidth - p.offsetWidth - w),
        ...
        slidePrev: function(t, e, i) {
            ...
            var c, d = n(l ? this.translate : -this.translate), h = r.map(function(t) {
                return n(t)
            }), u = (o.map(function(t) {
                return n(t)
            }),
    ...
    O = "MacIntel" === w,
    !_ && O && g.touch && (1024 === S && 1366 === C || 834 === S && 1194 === C || 834 === S && 1112 === C || 768 === S && 1024 === C) && (_ = x.match(/(Version)\/([\d.]+)/),
    O = !1),
    T.ie = P,
    T.edge = $,
    T.firefox = L,
    ...
    (_ || k || M) && (T.os = "ios",
    T.ios = !0),
    k && !M && (T.osVersion = k[2].replace(/_/g, "."),
    T.iphone = !0),
    _ && (T.osVersion = _[2].replace(/_/g, "."),
    T.ipad = !0),
    M && (T.osVersion = M[3] ? M[3].replace(/_/g, ".") : null,
    T.ipod = !0),
    ...
    T), j = !1, q = {
        ...
        events: {
            attachEvents: function() {
                ...
                if (!g.touch && g.pointerEvents)
                    ...
                    if (g.touch) {
                        ...
                        j || (h.addEventListener("touchstart", d),
                        j = !0)
                    }
                    (t.simulateTouch && !H.ios && !H.android || t.simulateTouch && !g.touch && H.ios) && (i.addEventListener("mousedown", this.onTouchStart, !1),
            ...
            detachEvents: function() {
                ...
                if (!g.touch && g.pointerEvents)
                    ...
                    (t.simulateTouch && !H.ios && !H.android || t.simulateTouch && !g.touch && H.ios) && (i.removeEventListener("mousedown", this.onTouchStart, !1),
        ...
        function e() {
            ...
            if (s = d[0]) {
                ...
                return s.swiper = l,
                d.data("swiper", l),
                s && s.shadowRoot && s.shadowRoot.querySelector ? (u = i(s.shadowRoot.querySelector("." + l.params.wrapperClass))).children = function(t) {
                    return d.children(t)
                }
        ...
        update: function(t) {
            ...
            if (t)
                ...
                for (var M = h; M <= u; M += 1)
                    (M < T || M > S) && i.$wrapperEl.find("." + i.params.slideClass + '[data-swiper-slide-index="' + M + '"]').remove();
            for (var k = 0; k < p.length; k += 1)
                k >= T && k <= S && (void 0 === u || t ? _.push(k) : (k > u && _.push(k),
                k < h && E.push(k)));
        ...
        enable: function() {
            this.keyboard.enabled || (i(h).on("keydown", this.keyboard.handle),
            this.keyboard.enabled = !0)
        },
        disable: function() {
            this.keyboard.enabled && (i(h).off("keydown", this.keyboard.handle),
            ...
            n.params.freeMode) {
                ...
                if (!h) {
                    ...
                    var u = n.getTranslate() + r * s.sensitivity
                      , p = n.isBeginning
                      , f = n.isEnd;
                    if (u >= n.minTranslate() && (u = n.minTranslate()),
        ...
        update: function() {
            ...
            if (e.el && this.pagination.el && this.pagination.$el && 0 !== this.pagination.$el.length) {
                ...
                "progressbar" === e.type) {
                    ...
                    a.find("." + e.progressbarFillClass).transform("translate3d(0,0,0) scaleX(" + T + ") scaleY(" + S + ")").transition(this.params.speed)
                }
        ...
        onTouchStart: function(t) {
            var e = this.zoom
              , i = e.gesture
              , n = e.image;
            i.$imageEl && 0 !== i.$imageEl.length && (n.isTouched || (H.android && t.cancelable && t.preventDefault(),
            n.isTouched = !0,
        ...
        in: function(t) {
            var e, i, n, s, a, r, o, l, c, d, h, u, p, f, m, v, g = this.zoom, b = this.params.zoom, y = g.gesture, w = g.image;
                ...
                0 !== r.length && r.each(function(t, r) {
                    ...
                    n.loadImage(o[0], c || l, d, h, !1, function() {
                        if (null != n && n && (!n || n.params) && !n.destroyed) {
                            ...
                            u.length && u.children("source").each(function(t, e) {
                                var n = i(e);
        ...
        load: function() {
            ...
            n.params.watchSlidesVisibility)
                ...
                for (var h = o; h < o + d; h += 1)
                    t(h) && n.lazy.loadInSlide(h);
            else
                n.lazy.loadInSlide(o);
            if (c.loadPrevNext)
                if (d > 1 || c.loadPrevNextAmount && c.loadPrevNextAmount > 1) {
                    for (var u = c.loadPrevNextAmount, p = d, f = Math.min(o + p + Math.max(u, p), r.length), m = Math.max(o - Math.max(p, u), 0), v = o + d; v < f; v += 1)
        ...
        setTranslate: function() {
            var t, e = this.$el, n = this.$wrapperEl, s = this.slides, a = this.width, r = this.height, o = this.rtlTranslate, l = this.size, c = this.params.cubeEffect, d = this.isHorizontal(), h = this.virtual && this.params.virtual.enabled, u = 0;
            ...
            for (var p = 0; p < s.length; p += 1) {
                ...
                c.slideShadows) {
                    ...
                    0 === S.length && (S = i('<div class="swiper-slide-shadow-' + (d ? "left" : "top") + '"></div>'),
                    f.append(S)),
        ...
        setTranslate: function() {
            for (var t = this.slides, e = this.rtlTranslate, n = 0; n < t.length; n += 1) {
                ...
                this.params.flipEffect.slideShadows) {
                    ...
                    s.append(d)),
                    0 === h.length && (h = i('<div class="swiper-slide-shadow-' + (this.isHorizontal() ? "right" : "bottom") + '"></div>'),
                    s.append(h)),
        ...
        update: function(t) {
            ...
            if (e) {
                ...
                e.params.loop || e.params.virtual && e.params.virtual.enabled)
                    for (var u = 0; u < d; u += 1)
                        e.$wrapperEl.children('[data-swiper-slide-index="' + (this.realIndex + u) + '"]').addClass(h);
                else
                    for (var p = 0; p < d; p += 1)
...
function(t, e, i, n) {
    ...
    i) {
        ...
        i.extend(v.prototype, {
            ...
            jumpTo: function(t, e) {
                var n, s, a, r, o, l, c, d, h, u = this, f = u.group.length;
                if (!(u.isDragging || u.isClosing || u.isAnimating && u.firstRun)) {
                    if (t = parseInt(t, 10),
                    !(a = u.current ? u.current.opts.loop : u.opts.loop) && (t < 0 || t >= f))
                        return !1;
                    ...
                    u.prevPos = u.currPos,
                    r = u.createSlide(t),
                    f > 1 && ((a || r.index < f - 1) && u.createSlide(t + 1),
                    ...
                    s ? (h = l.left - (o.pos * l.width + o.pos * o.opts.gutter),
            ...
            scaleToActual: function(t, e, n) {
                var s, a, r, o, l, c = this, d = c.current, h = d.$content, u = i.fancybox.getTranslate(d.$slide).width, p = i.fancybox.getTranslate(d.$slide).height, f = d.width, m = d.height;
            ...
            getFitPos: function(t) {
                var e, n, s, a, r = this, o = t.$content, l = t.$slide, c = t.width || t.opts.width, d = t.height || t.opts.height, h = {};
                ...
                c > e - .5 && (c = e),
                d > n - .5 && (d = n),
                "image" === t.type ? (h.top = Math.floor(.5 * (n - d)) + parseFloat(l.css("paddingTop")),
                h.left = Math.floor(.5 * (e - c)) + parseFloat(l.css("paddingLeft"))) : "video" === t.contentType && (a = t.opts.width && t.opts.height ? c / d : t.opts.ratio || 16 / 9,
            ...
            revealContent: function(t) {
                var e, n, s, a, r = this, o = t.$slide, l = !1, c = !1, d = r.isMoved(t), h = t.isRevealed;
                ...
                h || !d || "image" !== t.type || t.hasError || t.$content.hide().fadeIn("fast"),
            ...
            close: function(t, e) {
                var n, s, a, r, o, l, c, h = this, u = h.current, f = function() {
                    h.cleanUp(t)
                };
                ...
                s && h.$refs.container.removeClass("fancybox-is-open").addClass("fancybox-is-closing").css("transition-duration", s + "ms"),
                h.hideLoading(u),
                h.hideControls(!0),
                h.updateCursor(),
                ...
                "auto" == o && (o = Math.abs(u.width / u.height - c.width / c.height) > .1),
                o && (c.opacity = 0),
                i.fancybox.setTranslate(a, l),
                p(a),
                i.fancybox.animate(a, c, s, f),
                0) : (n && s ? i.fancybox.animate(u.$slide.addClass("fancybox-slide--previous").removeClass("fancybox-slide--current"), "fancybox-animated fancybox-fx-" + n, s, f) : !0 === t ? setTimeout(f, s) : f(),
                0))))
            },
            cleanUp: function(e) {
    ...
    t(document).on("objectNeedsType.fb", function(n, s, a) {
        ...
        t.each(r, function(e, n) {
            if (l = p.match(n.matcher)) {
                ...
                return c = t.extend(!0, {}, n.params, a.opts[e], h),
...
function(t, e, i) {
    ...
    d.prototype.ontouchstart = function(n) {
        ...
        (!n.originalEvent || 2 != n.originalEvent.button) && u.length && l.length && !o(l) && !o(l.parent()) && (l.is("img") || !(n.originalEvent.clientX > l[0].clientWidth + l.offset().left))) {
            ...
            s.startPoints.length && (h.touch && n.stopPropagation(),
            s.startEvent = n,
            s.canTap = !0,
            s.$target = l,
            s.$content = p,
            ...
            (1 === s.startPoints.length || h.hasError) && (s.canPan ? (i.fancybox.stop(s.$content),
            s.isPanning = !0) : s.isSwiping = !0,
            s.$container.addClass("fancybox-is-grabbing")),
            2 === s.startPoints.length && "image" === h.type && (h.isLoaded || h.$ghost) && (s.canTap = !1,
            s.isSwiping = !1,
            s.isPanning = !1,
            s.isZooming = !0,
    ...
    d.prototype.limitMovement = function() {
        var t, e, i, n, s, a, r = this, o = r.canvasWidth, l = r.canvasHeight, c = r.distanceX, d = r.distanceY, h = r.contentStartPos, u = h.left, p = h.top, f = h.width, m = h.height;
        return s = f > o ? u + c : u,
        a = p + d,
        ...
        c > 0 && s > t && (s = t - 1 + Math.pow(-t + u + c, .8) || 0),
        c < 0 && s < i && (s = i + 1 - Math.pow(i - u - c, .8) || 0),
    ...
    d.prototype.onTap = function(e) {
        var n, s = this, r = i(e.target), o = s.instance, l = o.current, c = e && a(e) || s.startPoints, d = c[0] ? c[0].x - i(t).scrollLeft() - s.stagePos.left : 0, h = c[0] ? c[0].y - i(t).scrollTop() - s.stagePos.top : 0, u = function(t) {
            var n = l.opts[t];
        ...
        if (T) {
            ...
            if ("loading" !== document.readyState)
                if (S && o.onlyLegacy) {
                    ...
                    !z && (o.shadowDOM || o.rootElement.shadowRoot || o.rootElement.host) ? n({
                    ...
                    n({
                        ...
                        onComplete: function(n, a) {
                            ...
                            t(u, o.variables),
                            v = Boolean((document.querySelector("[data-cssvars]") || Object.keys(M.dom).length) && Object.keys(u).some(function(t) {
                                return u[t] !== p[t]
                            })),
                            t(p, M.user, u),
                            v)
